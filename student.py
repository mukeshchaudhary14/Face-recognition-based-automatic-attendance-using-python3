...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","B.TECH","BCA","B.COM","B.PHARMA","B.B.A")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","CS","MLAI","IT","CE","CSE")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2017-21","2018-22","2019-23","2020-24","2021-25","2022-26","2023-27")
            ...
            try:
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path=r"C:\Users\mc882\Videos\Captures\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master\data_img\student."+str(id)+"."+str(img_id)+".jpg"
