...
class Attendance:
    ...
    def action(self):
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                conn = mysql.connector.connect(username='root', password='Azsxdc!#312',host='127.0.0.1',database='fcedetect',port=3306)
                mycursor = conn.cursor()
    ...
    #     conn = mysql.connector.connect(username='root', password='root',host='127.0.0.1',database='facdetect',port=3306)
    #     mycursor = conn.cursor()
